...
func InitSession(username string,
	...
	session.CommandHistory = append(session.CommandHistory, "replace")
	session.CommandHistory = append(session.CommandHistory, "print")
	session.CommandHistory = append(session.CommandHistory, "process")
	session.CommandHistory = append(session.CommandHistory, "update")
	session.CommandHistory = append(session.CommandHistory, "delete")
