...
var (
	...
	ValidationSpecialSymbolsError = errors.New("validation error: do not use special symbols")
	ValidationCantBeCommand       = errors.New("validation error: command name not valid")
