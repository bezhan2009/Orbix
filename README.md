...
**Orbix** is an alternative command line interface written in the Go programming language. It provides the same basic Commands as the standard Orbix, but also includes additional Commands specific to this tool.
...
go run main.go
```
![image](https://github.com/OrbixUser-attachments/assets/acab7584-39ef-43ae-82a9-d022bbfc9359)
![image](https://github.com/OrbixUser-attachments/assets/7c4c019a-2372-4f0f-9303-fb368fe3bd83)
![image](https://github.com/OrbixUser-attachments/assets/cdf47169-2cb7-4f51-b729-9bc0dd0b3344)
...
- **NEWUSER**: Adds a new OrbixUser for Orbix.
...
- **SIGNOUT**: Logs out the OrbixUser from Orbix.
